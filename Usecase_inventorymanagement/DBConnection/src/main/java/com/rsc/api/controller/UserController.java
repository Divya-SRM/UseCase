...
import com.rsc.api.service.UserDetailService;
...
public class UserController {
	 ...
	 @Autowired
	    ...
	    public void saveUser(@RequestBody UserDetail user)
	    {    
	        userService.getuserdetails(user);  
	        System.out.println(HttpStatus.OK);
	    }
	    @PutMapping(value="/manage/{id}")
	    public void updateUser(@RequestBody UserDetail user)
	    {    
	        userService.getuserdetails(user);  
	        System.out.println(HttpStatus.OK);
	    }
	    @GetMapping(value="/manage")
	    public ResponseEntity<List<UserDetail>>viewProduct()
	    {    
	    
			return new ResponseEntity<List<UserDetail>>(userService.viewUser(),HttpStatus.OK);  
